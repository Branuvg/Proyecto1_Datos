...
/**
 * Clase que implementa una stack genérica utilizando un ArrayList.
 * Esta clase proporciona operaciones básicas para trabajar con una stack, como
 * agregar elementos, quitar elementos, verificar si la stack está vacía y obtener
 * el número de elementos en la stack.
 *
 * @param <T> Tipo de datos de los elementos de la stack.
 * @author Gabriel Bran
